...
# coq_makefile -R ../lib/tlc/ TLC -R . "" -install none Definitions.v Weakening.v Helper_lemmas.v Precise_types.v Invertible_typing.v Substitution.v Narrowing.v General_to_tight.v Canonical_forms.v Safety.v
#
