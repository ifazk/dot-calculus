...
Lemma hasnt_notin : forall G S ds ls t U,
    G, S /- ds :: U -> 
    record_typ U ls ->
    defs_hasnt ds t ->
    t \notin ls.
Proof.
  ...
  - inversions Hds. inversions H6; simpl in *; case_if; apply* notin_singleton.
  - apply notin_union; split.
    + inversions Hds. apply (IHHrec ds0 H5). simpl in *. case_if*.
    + inversions Hds. inversions H9; simpl in *; case_if; apply* notin_singleton.
Qed.
...
Proof. 
  ...
  - destruct T'; inversions H1. reflexivity.
  - destruct T'; inversions H2. apply f_equal. apply* (H T' k x).
...
Lemma val_typing: forall G S v T,
  ...
  exists T', G, S |-! trm_val v : T' /\
        G, S |- T' <: T.
Proof.
  intros G S v T H. dependent induction H.
