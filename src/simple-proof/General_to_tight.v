...
Lemma invertible_to_precise_typ_dec: forall G S x A V U,
  inert G ->
  G, S |-## x : typ_rcd (dec_typ A V U) ->
  exists T,
...
Lemma invertible_to_precise_typ_all: forall G S x V T,
  inert G ->
  G, S |-## x : typ_all V T ->
  exists V' T' L,
...
Lemma sel_replacement: forall G S x A V U,
    inert G ->
