...
# coq_makefile -R ../../lib/tlc/ TLC -R . "" -install none -o Makefile.coq Canonical_forms.v Definitions.v General_to_tight.v Helper_lemmas.v Invertible_typing.v Narrowing.v Operational_semantics.v Operational_semantics_old.v Precise_types.v Renaming.v Safety.v Safety_old.v Stack_equivalence.v Substitution.v Weakening.v 
#
...
html: $(GLOBFILES) $(VFILES)
	- mkdir -p ../doc
	$(COQDOC) -toc $(COQDOCFLAGS) -html $(COQDOCLIBS) -d ../doc $(VFILES)

gallinahtml: $(GLOBFILES) $(VFILES)
	- mkdir -p ../doc
	$(COQDOC) -toc $(COQDOCFLAGS) -html -g $(COQDOCLIBS) -d ../doc $(VFILES)
